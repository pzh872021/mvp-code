...
import com.mvp.net.exception.Exceptions;
import com.mvp.net.request.OkHttpRequest;
...
public class OtherRequest extends OkHttpRequest {
    ...
    protected Request buildRequest(RequestBody requestBody) {
        if (method.equals(OtherMethod.PUT)) {
            builder.put(requestBody);
        } else if (method.equals(OtherMethod.DELETE)) {
            if (requestBody == null)
                builder.delete();
            else
                builder.delete(requestBody);
        } else if (method.equals(OtherMethod.HEAD)) {
            builder.head();
        } else if (method.equals(OtherMethod.PATCH)) {
